...
export const formSchema = z
  .object({
    ...
    type: z.string().min(2, { message: "Enter the produce type." }),
    ...
    produceGrown: z
      .string()
      .min(2, { message: "Describe what is being grown." }),

    farmAddress: z.string().min(10, { message: "Enter a valid farm address." }),
  })
